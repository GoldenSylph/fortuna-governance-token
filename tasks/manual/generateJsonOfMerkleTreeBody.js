...
module.exports = (task) =>
  task(
    ...
    .addOptionalParam("pathToCsv", "Define a path to csv where the MerkleTree body is stored.", './resources/csv/holders.csv', types.string)
    .addOptionalParam("path", "Define a path to json where the MerkleTree body would be stored.", './holdersMerkleTreeBody.json', types.string)
